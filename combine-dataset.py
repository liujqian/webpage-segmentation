...
if __name__ == '__main__':
    ...
    if not os.path.isdir(os.path.join(wd, dataset_dirname)):
        ...
        exit(1)
    postfixes = ["annotations", "dom-and-nodes", "ground-truth", "screenshots-edges"]
    ...
    for dpid in os.scandir(os.path.join(wd, dataset_dirname, dataset_dirname + "-annotations", dataset_dirname)):
